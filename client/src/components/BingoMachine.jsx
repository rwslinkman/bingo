...
const BingoMachine = forwardRef(function BingoMachine({ canControl, onRotate }, ref) {
    ...
    useEffect(() => {
        ...
        // Balls
        const balls = [...Array(10)].map(() =>
            Bodies.circle(
                width / 2 + Math.random() * 80 - 40,
                height / 2 + Math.random() * 80 - 40,
                15,
                { restitution: 0.8, render: { fillStyle: "#3498db" } }
            )
        );
